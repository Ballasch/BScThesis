...
\usepackage[
  ...
  style=alphabetic, % german, has to be loaded with \setotherlanguages
  %citestyle=authoryear                 % in the references.bib use langid={en} for english sources
]{biblatex}
...
\input{content/02_sm.tex}
\input{content/03_measurement.tex}
\input{content/04_mc.tex}
\input{content/05_NN.tex}
\input{content/06_analysis.tex}
\input{content/07_figs_tabs.tex}
